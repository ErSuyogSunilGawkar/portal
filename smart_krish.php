...
<body class="skin-blue sidebar-collapse" oncontextmenu="return false;" id="canvas" >
		...
		<header class="main-header" id="myheader" style="min-width: 173vw;">
			...
			<nav class="navbar navbar-static-top bg-black-active" role="navigation" style="height:40px;!important">
				...
				<div class="navbar-custom-menu" style="float:none !important">
					...
					<ul class="nav navbar-nav" >
						<a href='../logout.php'><span class="btn btn-danger noCursor stylemargin pull-right" title="Logout">Logout</span></a>
					</ul>
				</div>
			</nav>
		</header>
	...
	<!-- Content Wrapper. Contains page content -->
		<div class="content-wrapper">
			...
			#	<li class="hassubs neftrepostfail_utr"><a target="_blank" href="reposting_mon.php" title="Reposting Count" class="repostfail <?php echo $classglowrepostfail;?>" style="<?php echo $repostfailcolor; ?>;borde	r-radius: 6px;"><?php echo "Reposting Status"; ?></a></li>
			...
			<div id="alldiv">
				<?php include("monitorExternalFile1.php"); ?>
			</div>
		</div>
